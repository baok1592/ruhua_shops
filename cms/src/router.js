...
export default new Router({
	routes: [
		...
		},
		{
			...
			name: 'B',
			component: () => import('./views/shops/shop/shop_approve.vue')
		},
		{
			path: '/shops/pro_list',
			name: 'pro_list',
		...
		},
		{
			path: '/set/backup',
			name: 'backup',
			component: () => import('./views/set/backup.vue')
		},
		{
			path: '/set/cehck_version',
			name: 'cehck_version',
			component: () => import('./views/set/cehck_version.vue')
		},
		{
			path: '/login',
			name: 'Login',
		...
		},
		{
			...
			name: 'distribution',
			component: () => import('./views/application/marketing/distribution.vue')
		},
		{
			path: '/application/marketing/customize_form',
			name: 'customize_form',
			component: () => import('./views/application/marketing/customize_form.vue')
		},
		{
			path: '/application/marketing/integral',
			name: 'integral',
			component: () => import('./views/application/marketing/integral.vue')
		},
		{
			path: '/application/marketing/assemble',
			name: 'assemble',
			component: () => import('./views/application/marketing/assemble.vue')
		},
		{
			path: '/b',
			name: 'b',
