		...
		data() {
			return {
				...
				list: [{
						id: 1,
						name: '签到',
						url: '/shops/qiandao/qiandao'
					},
					{
						id: 2,
						name: '积分',
						url: '/shops/point/point'
					},
					{
						id: 3,
						name: '秒杀',
						url: '/shops/miaosha/miaosha'
					},
					{
						id: 4,
						name: '限时折扣',
						url: '/shops/discount/discount'
					},
					{
						id: 16,
						name: '一元团购',
					...
					},
					{
						id: 8,
						name: '优惠券', 
						url: '/shops/coupon/coupon'
					},
					{
						id: 9,
						name: '分销商品',
						url: '/shops/extend-view/productList/productList?type=fx'
					},
					{
						id: 10,
						name: '视频购',
					...
					},
					{
						id: 11,
						name: '大转盘',
						url: '/shops/play/activity/draw'
					},
					{
						id: 12,
						name: '九宫格',
						url: '/shops/play/sherpa-jiugongge/sherpa-jiugongge'
					},
					{
						id: 13,
						name: '种树',
						url: '/shops/play/watering/watering'
					},
					{
						id: 15,
						name: '分类',
