 ...
 -->
						...
						<el-form-item label="用券时间">
							<el-radio-group v-model="time" style="text-align: left;" @change="time_type_change">
								...
								<el-radio :label="2">领券当日起&emsp;<el-input v-model="form.day" style="width:100px"></el-input>&emsp;天内可用</el-radio>
	...
	export default {
		...
		methods: {
			...
			onSubmit() {
				...
				this.http.post_show('coupon/coupon_add', this.form).then(() => {
					this.$message({
						type: 'success',
						message: '添加成功!'
					});
