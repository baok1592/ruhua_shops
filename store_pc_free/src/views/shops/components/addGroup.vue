<template>
	<div class="add-cate">
		<el-button type="primary" size="small" @click="addbox = true">添加商品分组</el-button>
		...
		<el-dialog title :visible.sync="addbox" width="35%" center>
			<el-form :model="addform" :rules="rules" ref="box-a">
				<el-form-item label="商品分组名称" :label-width="formLabelWidth" style="width: 80%" prop="category_name">
