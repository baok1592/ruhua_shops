	...
	export default {
		...
		onLaunch: function(options) { 
			// #ifdef MP-WEIXIN
				...
				if(options.query.sfm){
					uni.setStorageSync("level_one",options.query.sfm)
				}else{
		...
		onShow: function(options) { 
			if(options && options.query && options.query.sfm){ 
				uni.setStorageSync("level_one",options.query.sfm) 
			}
		},
		onHide: function() { 
		...
		methods: {
			set_shops_site() {
				...
				this.$api.http.get('shops/common/cfg').then(res => {
					...
					uni.setStorageSync('shops_site',data)
				})
