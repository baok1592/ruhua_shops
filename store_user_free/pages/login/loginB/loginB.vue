	...
	<view class="loginB">
		...
		<view class='wj'>
			<checkbox-group @change="read">
				...
				已阅读并同意<span @click="jump(1)">《用户协议》</span>和<span @click="jump(2)">《用户隐私政策》</span>
			</checkbox-group>
			<view class="xuanzhong" v-if="is_read" >
				<img src="../../../static/imgs/xuan1.png" @click="read"></img>
			</view>
		</view> 
	</view>
</template>
...
<style lang="less">
	.loginB {
		...
		.wj {
			...
			.xuanzhong{position: absolute;top: 2px;left: 23px;background-color: #fff;
