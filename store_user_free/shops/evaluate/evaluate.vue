	...
	export default {
		data() {
			return {
				...
				current: 5,
				index: 5,
				img: [require('@/static/imgs/8.jpg'), require('@/static/imgs/8.jpg'), require('@/static/imgs/8.jpg'), require('@/static/imgs/8.jpg'),
					require('@/static/imgs/8.jpg'), require('@/static/imgs/8.jpg'), require('@/static/imgs/8.jpg'), require('@/static/imgs/8.jpg'), require(
						'@/static/imgs/8.jpg')
				]
			};
		},
